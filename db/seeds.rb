...
profile4 = Profile.new(user: user, first_name: "Emma", last_name: "Smith", information: "Just love food. There's nothing that makes me happier.")
profile5 = Profile.new(user: user, first_name: "Olivia", last_name: "Williams", information: "Food just amazes me. I can spend all day thinking of it.")
profile6 = Profile.new(user: user, first_name: "Ava", last_name: "Moore", information: "Passionate about Food.")
profile7 = Profile.new(user: user, first_name: "Sophia", last_name: "Scott", information: "I could go to a restaurant every day. No better 3 times a day!")
profile8 = Profile.new(user: user, first_name: "Charlotte", last_name: "Hill", information: "I am a Food Photographer and Columnist of Ohhhhhhh that foooooood! DM me for fancy Restaurant Tips.")
profile9 = Profile.new(user: user, first_name: "Mia", last_name: "Davis", information: "Never met a calorie I didn't like!")
profile10 = Profile.new(user: user, first_name: "Amelia", last_name: "Miller", information: "But First.....Food!")
profile11 = Profile.new(user: user, first_name: "Grace", last_name: "Wilson", information: "Foodie and Food Photographer.")
profile12 = Profile.new(user: user, first_name: "Chloe", last_name: "Parker", information: "Yes I can eat all day long :)")
profile13 = Profile.new(user: user, first_name: "Zoey", last_name: "Harris", information: "Passionate about Cupcakes. Know all the best places to get them!")
profile14 = Profile.new(user: user, first_name: "Nora", last_name: "Jones", information: "Food is just amazing. It not only tastes incredible, it also connects people.")
profile15 = Profile.new(user: user, first_name: "Hannah", last_name: "Peterson", information: "Everything is better with Chocolate!")
profile16 = Profile.new(user: user, first_name: "Lucy", last_name: "Morgan", information: "Food? Always!")
profile17 = Profile.new(user: user, first_name: "Claire", last_name: "Howard", information: "Food is our Common Ground. A universal Experience.")
profile18 = Profile.new(user: user, first_name: "Anna", last_name: "Taylor", information: "Ohhhhhhh that foooooood!")
profile19 = Profile.new(user: user, first_name: "Liam", last_name: "Johnson", information: "All you need is.....Steak!")
profile20 = Profile.new(user: user, first_name: "Noah", last_name: "Clark", information: "Give me those burgers!!!!")
profile21 = Profile.new(user: user, first_name: "William", last_name: "Torres", information: "Vegetarian on Rehab!")
profile22 = Profile.new(user: user, first_name: "James", last_name: "Brown", information: "Meat addicted. Not even lying!")
profile23 = Profile.new(user: user, first_name: "Oliver", last_name: "Carter", information: "What I love about food? Everything!")
